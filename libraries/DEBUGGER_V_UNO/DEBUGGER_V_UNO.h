/*
	DEBUGGER_V_UNO Libreria avanzada para debuggear con el serial port
	Created by Victor Manuel Camacho.
*/

#ifndef DEBUGGER_V_UNO
#define DEBUGGER_V_UNO
...
class Debugger
{
  ...
  public:
	Debugger(boolean debugg,boolean debuggInput,int pauseTime);
