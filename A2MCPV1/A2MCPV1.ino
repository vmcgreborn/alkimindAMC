...
const unsigned int SERVO_OUTPUT_LIST[]={42,43,44,45,46,47,48,49};
const unsigned int CONMUTATE_OUTPUTS[]={26,27,28};
//menus
...
void setup() {
	...
	servos.begin(SERVO_OUTPUT_LIST,CONMUTATE_OUTPUTS);
